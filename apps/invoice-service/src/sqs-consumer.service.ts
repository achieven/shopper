...
export class SqsConsumerService implements OnModuleInit {
  ...
  private async startPolling() {
    console.log('Starting SQS polling for Invoice Service...');
  ...
  private async processMessage(message: SQS.Message) {
    try {
      ...
      if (eventType === EventType.REQUEST_CREATED) {
        await this.invoiceService.processInvoiceGeneration(requestId);
      }
